...
UCLASS(Abstract)
class GAMERUNTIME_API UInvSlotWidgetBase : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API UInventoryWidgetBase : public UToroWidget
{
	GENERATED_BODY()
...
protected:
	...
	void RefreshInfo();
	void RefreshSlots();
	void OnState(const bool bState);
