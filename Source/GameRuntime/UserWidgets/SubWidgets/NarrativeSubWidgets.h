...
UCLASS(Abstract)
class GAMERUNTIME_API UQuestTaskWidgetBase final : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API UQuestBranchWidgetBase final : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API UDialogueOptionWidgetBase final : public UUserWidget
{
	GENERATED_BODY()
