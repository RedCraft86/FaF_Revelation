...
UCLASS(Abstract)
class GAMERUNTIME_API USettingTooltipBase : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API USettingRowBase : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API UToggleRowBase : public USettingRowBase
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API USliderRowBase : public USettingRowBase
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API USwapperRowBase : public USettingRowBase
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API USelectorRowBase : public USettingRowBase
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API UResolutionRowBase : public USelectorRowBase
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GAMERUNTIME_API UImageFidelityBase : public USelectorRowBase
{
	GENERATED_BODY()
