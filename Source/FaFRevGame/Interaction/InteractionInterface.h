...
struct FAFREVGAME_API FInteractionInfo
{
	...
	FInteractionInfo() : Interaction(EInteractType::Instant), HoldingTime(1.0f)
		, Label(INVTEXT("Interact")), LabelOffset(0.0f), Icon(nullptr), IconSize(35.0f)
	{}

	bool CanInteract() const { return Interaction != EInteractType::None; }

	static FInteractionInfo GetEmpty()
	{
		FInteractionInfo Info;
		Info.Interaction = EInteractType::None;
		return Info;
	}
};
