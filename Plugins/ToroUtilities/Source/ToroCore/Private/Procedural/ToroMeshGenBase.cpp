...
AToroMeshGenBase::AToroMeshGenBase() : bRealtimeConstruction(true)
{
...
void AToroMeshGenBase::OnConstruction(const FTransform& Transform)
{
...
TArray<int32> AToroMeshGenBase::LoopMeshArray(const TArray<FTransformMeshData>& Sample, const EGeneratorLoopMode Mode, const uint8 Amount)
{
