...
#include "DataGraphEdSchema.generated.h"

USTRUCT()
struct FDataGraphAction_NewNode : public FEdGraphSchemaAction
{
	GENERATED_BODY();
	...
	TObjectPtr<class UDataGraphEdNode> NodeTemplate;
};

USTRUCT()
struct FDataGraphAction_NewEdge : public FEdGraphSchemaAction
{
	GENERATED_BODY();
	...
	TObjectPtr<class UDataGraphEdEdge> NodeTemplate;
};

UCLASS()
class UDataGraphEdSchema final : public UEdGraphSchema
{
	GENERATED_BODY()
