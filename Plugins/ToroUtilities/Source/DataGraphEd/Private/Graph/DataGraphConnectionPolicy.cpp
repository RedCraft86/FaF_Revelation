...
FVector2f FDataGraphConnectionPolicy::ComputeSplineTangent(const FVector2f& Start, const FVector2f& End) const
{
...
void FDataGraphConnectionPolicy::DrawSplineWithArrow(const FVector2f& StartPoint, const FVector2f& EndPoint, const FConnectionParams& Params)
{
...
void FDataGraphConnectionPolicy::DrawPreviewConnector(const FGeometry& PinGeometry, const FVector2f& StartPoint, const FVector2f& EndPoint, UEdGraphPin* Pin)
{
...
{
	if (UDataGraphEdEdge* EdgeNode = Cast<UDataGraphEdEdge>(InputPin->GetOwningNode()))
	{
...
void FDataGraphConnectionPolicy::Internal_DrawLineWithArrow(const FVector2f& StartAnchorPoint, const FVector2f& EndAnchorPoint, const FConnectionParams& Params)
{
