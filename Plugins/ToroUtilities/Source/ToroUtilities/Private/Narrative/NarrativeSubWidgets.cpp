...
void UQuestTaskWidget::InitWidget(UNarrativeWidget* InParent, const UNarrativeTask* InTask)
{
	ParentUI = InParent;
	TaskObject = InTask;
	if (TaskObject)
...
void UQuestBranchWidget::InitWidget(UNarrativeWidget* InParent, const UQuestBranch* InBranch)
{
	ParentUI = InParent;
...
void UDialogueOptionWidget::InitWidget(UNarrativeWidget* InParent, UDialogue* InDialogue, UDialogueNode_Player* InReply)
{
	ParentUI = InParent;
	ReplyObject = InReply;
