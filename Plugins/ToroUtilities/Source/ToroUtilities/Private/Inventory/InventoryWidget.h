...
UCLASS(Abstract)
class TOROUTILITIES_API UInvSlotWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Transient) TObjectPtr<UInventoryWidget> ParentUI;
...
UCLASS(Abstract)
class TOROUTILITIES_API UInventoryWidget : public UToroWidget
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Category = Settings)
		TSubclassOf<UInvSlotWidget> SlotWidgetClass;
...
protected:
	...
	UPROPERTY(Transient) TMap<FGuid, TObjectPtr<UInvSlotWidget>> SlotWidgets;
