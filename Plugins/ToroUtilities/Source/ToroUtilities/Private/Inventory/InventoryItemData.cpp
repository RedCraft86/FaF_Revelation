...
UE_DEFINE_GAMEPLAY_TAG_BASE(InvMeta)
UE_DEFINE_GAMEPLAY_TAG_CHILD(NameID, InvMeta)
UE_DEFINE_GAMEPLAY_TAG_CHILD(DescID, InvMeta)
UE_DEFINE_GAMEPLAY_TAG_CHILD(MeshID, InvMeta)
UE_DEFINE_GAMEPLAY_TAG_CHILD(KeyID, InvMeta)
UE_DEFINE_GAMEPLAY_TAG_CHILD(ReuseKey, InvMeta)
UE_DEFINE_GAMEPLAY_TAG_CHILD(JsonData, InvMeta)
...
FText UInventoryItemData::GetDisplayName(const FInventoryMetadata& InMetadata) const
{
	...
	if (const FString* NameKey = InMetadata.Find(Tag_InvMeta_NameID))
	{
...
FText UInventoryItemData::GetDescription(const FInventoryMetadata& InMetadata) const
{
	...
	if (const FString* NameKey = InMetadata.Find(Tag_InvMeta_DescID))
	{
...
FTransformMeshData UInventoryItemData::GetMeshData(const FInventoryMetadata& InMetadata) const
{
	...
	if (const FString* MeshKey = InMetadata.Find(Tag_InvMeta_MeshID))
	{
