...
namespace Nvidia
{
	namespace NIS
	{
		...
		{
			return false; // UNISLibrary::IsNISSupported();
		}
	...
	namespace DLSS
	{
		...
		{
			return false; // UDLSSLibrary::IsDLSSSupported();
		}
		...
		static void SetDLSSMode(const uint8 InMode)
		{
			...
			// UDLSSLibrary::SetDLSSMode(nullptr, Mode);
		}

		static bool IsDLSSRRSupported()
		{
			return false; // UDLSSLibrary::IsDLSSRRSupported();
		}
		...
		{
			return false; // UStreamlineLibraryDLSSG::IsDLSSGSupported();
		}
	...
	namespace Streamline
	{
		...
		{
			return false; // UStreamlineLibraryReflex::IsReflexSupported();
		}
		...
		{
			return false; // UStreamlineLibraryDeepDVC::IsDeepDVCSupported();
		}
