...
struct TOROUTILITIES_API FElectricLightEntry
{
	GENERATED_BODY()
...
struct TOROUTILITIES_API FElectricLightAnim
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class TOROUTILITIES_API AElectricLightBase final : public AElectricActorBase
{
	GENERATED_BODY()
