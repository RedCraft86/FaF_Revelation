...
struct TOROUTILITIES_API FWControlDelay final : public FWorldActionBase
{
	GENERATED_BODY()
...
struct TOROUTILITIES_API FWControlFlipFlop final : public FWorldActionBase
{
	GENERATED_BODY()
...
struct TOROUTILITIES_API FWControlDoOnce final : public FWorldActionBase
{
	GENERATED_BODY()
