...
UE_DECLARE_GAMEPLAY_TAG_BASE(InvMeta)
UE_DECLARE_GAMEPLAY_TAG_CHILD(NameID, InvMeta)
UE_DECLARE_GAMEPLAY_TAG_CHILD(DescID, InvMeta)
UE_DECLARE_GAMEPLAY_TAG_CHILD(MeshID, InvMeta)
UE_DECLARE_GAMEPLAY_TAG_CHILD(KeyID, InvMeta)
UE_DECLARE_GAMEPLAY_TAG_CHILD(ReuseKey, InvMeta)
UE_DECLARE_GAMEPLAY_TAG_CHILD(JsonData, InvMeta)
...
struct TOROUTILITIES_API FInventoryMetadata
{
	GENERATED_BODY()
...
class TOROUTILITIES_API UInventoryItemData final : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	TMap<FGameplayTag, FString> MetadataKeyGuide{
		{Tag_InvMeta_NameID,		TEXT("Used with the Alt Names Attribute.")},
		{Tag_InvMeta_DescID,		TEXT("Used with the Alt Descriptions Attribute.")},
		{Tag_InvMeta_MeshID,		TEXT("Used with the Alt Meshes Attribute.")},
		{Tag_InvMeta_KeyID,		TEXT("This item will be able to unlock locks with matching IDs.")},
		{Tag_InvMeta_ReuseKey,	TEXT("Used for key types. Signifies that a key is reusable for other locks.")},
		{Tag_InvMeta_JsonData,	TEXT("Used for equipment types to store extra equipment data.")}
	};
#endif
