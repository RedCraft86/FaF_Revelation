...
struct TOROUTILITIES_API FInvMetaFilter
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct TOROUTILITIES_API FInvSlotData
{
	GENERATED_BODY()
...
struct TOROUTILITIES_API FInvSaveData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintInternalUseOnly)
struct TOROUTILITIES_API FInvEquipData
{
	GENERATED_BODY()
...
class TOROUTILITIES_API UInventoryComponent : public UActorComponent
{
	GENERATED_BODY()
