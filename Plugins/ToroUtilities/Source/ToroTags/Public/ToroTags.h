...
#define GAMEPLAY_TAG_BASE(TagName) Tag_##TagName
...
#define GAMEPLAY_TAG_CHILD(BaseTag, TagName) Tag_##BaseTag##_##TagName
...
class FToroTagsModule final : public IModuleInterface
{
public:
