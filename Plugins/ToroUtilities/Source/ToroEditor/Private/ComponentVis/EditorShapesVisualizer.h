...
class FEditorShapesVisualizer final : public FComponentVisualizer
{
public:
	
	static TSharedPtr<FComponentVisualizer> MakeInstance()
	{
		return MakeShareable(new FEditorShapesVisualizer);
	}
...
private:
	...
	{
		if (const UEditorShapesComponent* VizComponent = Cast<const UEditorShapesComponent>(Component))
		{
