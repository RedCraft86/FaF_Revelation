...
class FPropertyMetadataCustomization final : public IDetailCustomization
{
public:

	static TSharedPtr<IDetailCustomization> MakeInstance(TSharedPtr<IBlueprintEditor> InBlueprintEditor);

	FPropertyMetadataCustomization(const TSharedPtr<IBlueprintEditor>& InBlueprintEditor, UBlueprint* Blueprint)
		...
		, NonEditableKeys({
			...
			"ClampMin", "ClampMax", "UIMin", "UIMax", "GetOptions", "EditInline", "EditCondition", "EditConditionHides",
			"InlineEditConditionToggle", "InlineCategoryProperty", "ShowOnlyInnerProperties", "HideAlphaChannel", "ForceInlineRow"
		})
	{}
