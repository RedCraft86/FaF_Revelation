...
void FPropertyMetadataDetails::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	if (Property->IsA(FStructProperty::StaticClass()))
	{
		...
		[
			SNew(SCheckBox)
			.IsChecked(DoesMetadataExist(PropertyName, "ShowOnlyInnerProperties") ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
	...
	if (IsPropertyOfStruct(Property, TBaseStructure<FLinearColor>::Get()))
	{
		...
		[
			SNew(SCheckBox)
			.IsChecked(DoesMetadataExist(PropertyName, "HideAlphaChannel") ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
	...
	if (IsMapWithStructKey(Property))
	{
		...
		[
			SNew(SCheckBox)
			.IsChecked(DoesMetadataExist(PropertyName, "ForceInlineRow") ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
	...
	if (Property->IsA(FBoolProperty::StaticClass()) || Property->IsA(FEnumProperty::StaticClass()) || Property->IsA(FByteProperty::StaticClass()))
	{
		...
		[
			SNew(SCheckBox)
			.IsChecked(DoesMetadataExist(PropertyName, "InlineCategoryProperty") ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
	...
	if (Property->IsA(FBoolProperty::StaticClass()))
	{
		...
		[
			SNew(SCheckBox)
			.IsChecked(DoesMetadataExist(PropertyName, "InlineEditConditionToggle") ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
	...
	if (!GetMetadataValue(PropertyName, "EditCondition").IsEmpty())
	{
		...
		[
			SNew(SCheckBox)
			.IsChecked(DoesMetadataExist(PropertyName, "EditConditionHides") ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
...
TArray<FBPVariableMetaDataEntry> FPropertyMetadataDetails::GetMetadataEntries(const int PropertyIndex) const
{
...
int FPropertyMetadataDetails::GetMetadataCount(const FName Property) const
{
...
bool FPropertyMetadataDetails::DoesMetadataExist(const FName Property, const FName Key) const
{
...
void FPropertyMetadataDetails::RemoveMetadata(const FName Property, const FName Key) const
{
...
FString FPropertyMetadataDetails::GetMetadataValue(const FName Property, const FName Key) const
{
...
void FPropertyMetadataDetails::SetMetadataValue(const FName Property, const FName Key, const FString& Value) const
{
...
void FPropertyMetadataDetails::ChangeMetadataKey(const FName Property, const FName OldKey, const FName NewKey) const
{
...
void FPropertyMetadataDetails::ChangeMetadataValue(const FName Property, const FName Key, const FString& Value, bool bDeleteEmpty) const
{
	if (Property.IsNone() || Key.IsNone()) return;
...
void FPropertyMetadataDetails::VerifyMetadata(const FName Property, const FName Key) const
{
	if (Property.IsNone() || Key.IsNone()) return;
