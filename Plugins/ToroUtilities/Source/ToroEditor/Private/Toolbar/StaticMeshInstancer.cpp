...
#endif
					if (UInstancedStaticMeshComponent* NewComp = ISMActor->GetMeshComponent<UInstancedStaticMeshComponent>())
					{
						NewComp->ClearInstances();
						NewComp->AddInstances(Mesh.Transforms, false, true);
					}
				}
				else
				{
