...
private:
	...
	static AStaticMeshActor* SpawnActor(class UEditorActorSubsystem* Subsystem, const FStaticMeshData& MeshProperties, const FTransform& Transform, const FString& Label, const FString& Folder);
};