...
#include "Graph/DataGraphFactory.h"
...
bool UDataGraphFactory::ConfigureProperties()
{
	...
	const bool bPicked = SClassPickerDialog::PickClass(NSLOCTEXT("ToroGraphEd", "GraphFactory", "Pick Data Graph Class"),
...
UObject* UDataGraphFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name,
